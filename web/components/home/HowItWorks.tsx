...
const ICONS = [
  <svg key="0" viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
    <rect x="3" y="4" width="18" height="18" rx="2" />
    <path d="M16 2v4M8 2v4M3 10h18" />
  </svg>,
  <svg key="1" viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
    <path d="M12 14c4 0 7 2 7 5v1H5v-1c0-3 3-5 7-5z" />
    <circle cx="12" cy="8" r="4" />
  </svg>,
  <svg key="2" viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
...
const COPY = {
  es: {
    ...
    steps: [
      ...
      { n: "02", title: "Conoce a tu profesor",    body: "45 minutos online: te evalúa el nivel y arma un plan a tu medida." },
      { n: "03", title: "Domina el alemán",         body: "Clases 1-a-1 + práctica con Hans 24/7 + diploma MCER al terminar." },
    ],
  },
  de: {
    ...
    steps: [
      ...
      { n: "02", title: "Triff deine Lehrkraft",   body: "45 Minuten online: Niveau-Einschätzung + maßgeschneiderter Plan." },
      { n: "03", title: "Beherrsche Deutsch",      body: "1-zu-1-Unterricht + Hans 24/7 + Abschlussdiplom nach GER." },
    ],
  },
} as const;
