...
function renderES(v: TrialAttendedFollowupVars): RenderedEmail {
  ...
  const body = `
    ...
    <p style="margin:0 0 14px 0;font-size:13px;color:#64748b;">
      ...
      <a href="https://web.whatsapp.com/send?phone=4915253409644" style="display:inline-block;background:#25D366;color:#ffffff;text-decoration:none;padding:5px 12px;border-radius:999px;font-size:12px;font-weight:600;vertical-align:middle;line-height:1.2;">💬 WhatsApp</a>
    </p>
  ...
  const text = [
    ...
    intro, ``, middle, ``,
    `🔗 ${v.ctaUrl}`, ``,
    `Si tienes dudas, escríbenos por WhatsApp: https://web.whatsapp.com/send?phone=4915253409644`, ``,
