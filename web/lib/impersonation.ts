...
type ImpersonatePayload = {
  ...
  target_role:   "teacher" | "student" | "closer" | "setter";
  target_name:   string;
  target_email:  string;
  exp:           number;                                    // epoch ms
};
...
export async function resolveEffectiveUser(opts: {
  ...
  fallbackRole:   "superadmin" | "admin" | "teacher" | "student" | "closer" | "setter";
  expectRole?:    "teacher" | "student" | "closer" | "setter";   // refuse impersonation if role mismatches
}): Promise<{
  userId:       string;
  role:         "superadmin" | "admin" | "teacher" | "student" | "closer" | "setter";
