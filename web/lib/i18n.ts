...
export const translations = {
  es: {
    ...
    home: {
      ...
      faq1Q: "¿Cuánto duran los cursos?",
      faq1A: "Depende de tu meta. Para ir de A0 a B1 (visa / trabajo) lo habitual es 6–12 meses con un plan intensivo. Tu profesor diseña el calendario en la primera clase.",
  ...
  de: {
    ...
    home: {
      ...
      faq1Q: "Wie lange dauern die Kurse?",
      faq1A: "Das hängt von deinem Ziel ab. Von A0 auf B1 (Visum / Job) brauchen die meisten 6–12 Monate mit einem Intensivplan. Dein Lehrer plant den Fahrplan in der ersten Stunde.",
