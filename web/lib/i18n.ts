...
export const translations = {
  es: {
    ...
    home: {
      ...
      faq6Q: "¿Dan certificado al terminar?",
      faq6A: "Sí. Emitimos un certificado de nivel reconocido en toda Europa según el MCER (Marco Común Europeo de Referencia para las Lenguas), válido para presentar en trabajos, universidades y trámites de visado. Lo recibes en PDF cuando completas tu nivel (A1, A2, B1, B2 o C1).",
  ...
  de: {
    ...
    home: {
      ...
      faq6A: "Ja. Wir stellen ein europaweit anerkanntes Sprachzertifikat nach GER (Gemeinsamer Europäischer Referenzrahmen) aus — gültig für Job-Bewerbungen, Universitäten und Visaverfahren. Du erhältst es als PDF, sobald du dein Niveau (A1, A2, B1, B2 oder C1) abgeschlossen hast.",
