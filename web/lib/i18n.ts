...
export const translations = {
  es: {
    ...
    home: {
      ...
      faq6Q: "¿Recibo un certificado al terminar?",
      faq6A: "Sí. Recibes un diploma de finalización de la academia Aprender-Aleman.de según los niveles del Marco Común Europeo de Referencia (MCER), de A1 a C1. También te preparamos para los exámenes oficiales Goethe, TELC u ÖSD si quieres una certificación reconocida internacionalmente.",
  ...
  de: {
    ...
    home: {
      ...
      faq6Q: "Bekomme ich am Ende ein Zertifikat?",
      faq6A: "Ja. Du erhältst ein Abschlussdiplom der Akademie Aprender-Aleman.de nach den Stufen des Gemeinsamen Europäischen Referenzrahmens (GER), von A1 bis C1. Auf Wunsch bereiten wir dich auch auf die offiziellen Prüfungen Goethe, TELC oder ÖSD vor — für eine international anerkannte Zertifizierung.",
