...
export const metadata: Metadata = {
  ...
  description:
    "Curso de alemán online con profesores nativos que hablan español. Clases en directo, plan a tu medida y certificado A1 hasta B2. Primera clase de prueba GRATIS.",
...
export default function Page() {
  return (
    <LandingStep0
      ...
      bullets={[
        <>Clases <strong>en directo</strong> (no grabaciones), grupos pequeños o 1 a 1</>,
        <>Plan <strong>adaptado a tu nivel</strong> y a tu objetivo, no un curso genérico</>,
        <>Certificado oficial al terminar (<strong>A1 · A2 · B1 · B2</strong>)</>,
      ]}
