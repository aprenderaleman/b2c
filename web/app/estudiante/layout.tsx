      ...
      <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-14 flex items-center justify-between">
          <nav className="flex items-center gap-6 text-sm font-medium">
            ...
            <Link href="/estudiante/tareas" className="text-slate-700 dark:text-slate-200 hover:text-brand-600 dark:hover:text-brand-400">Tareas</Link>
            <Link href="/estudiante/certificados" className="text-slate-700 dark:text-slate-200 hover:text-brand-600 dark:hover:text-brand-400">Certificados</Link>
