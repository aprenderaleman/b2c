...
export const metadata: Metadata = {
  ...
  description:
    "Clases de alemán en tu ciudad — la misma cercanía que una academia, desde casa y en directo. Profesores nativos, certificado A1 a B2. Primera clase de prueba GRATIS.",
  ...
  return (
    <LandingStep0
      ...
      bullets={[
        ...
        <>Horarios flexibles compatibles con tu trabajo (mañanas, tardes, noches)</>,
        <>Acceso a profesores nativos de toda Alemania, Austria y Suiza</>,
      ]}
